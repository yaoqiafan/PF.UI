    ...
    public partial class TextEffectsDemoView : UserControl
    {
        ...
        private void OnLoaded(object sender, RoutedEventArgs e)
        {
            ...
            _anchors = new Dictionary<string, FrameworkElement>
            {
                ...
                ["Simple"]    = Section_Simple,
            };
            _tocMap = new Dictionary<string, DemoTocItem>();
            if (DataContext is TextEffectsDemoViewModel vm)
            {
        ...
        {
            if (_navigating || _anchors == null || DataContext is not TextEffectsDemoViewModel) return;
            UpdateActiveToc();
        }

        private void UpdateActiveToc()
        {
            if (_anchors == null || DataContext is not TextEffectsDemoViewModel) return;
