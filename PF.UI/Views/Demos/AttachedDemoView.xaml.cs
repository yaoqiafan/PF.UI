...
namespace PF.UI.Views.Demos
{
    public partial class AttachedDemoView : UserControl
    {
        ...
        private void OnLoaded(object sender, RoutedEventArgs e)
        {
            ...
            if (DataContext is AttachedDemoViewModel vm)
            {
        ...
        {
            if (_navigating || _anchors == null || DataContext is not AttachedDemoViewModel) return;
            UpdateActiveToc();
        }

        private void UpdateActiveToc()
        {
            if (_anchors == null || DataContext is not AttachedDemoViewModel) return;
