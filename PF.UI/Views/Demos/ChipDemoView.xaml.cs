    ...
    public partial class ChipDemoView : UserControl
    {
        ...
        private void OnLoaded(object sender, RoutedEventArgs e)
        {
            ...
            _anchors = new Dictionary<string, FrameworkElement>
            {
                ...
                ["Outlined"]  = Section_Outlined,
                ["Icon"]      = Section_Icon,
                ["Deletable"] = Section_Deletable,
            };
            _tocMap = new Dictionary<string, DemoTocItem>();
            if (DataContext is ChipDemoViewModel vm)
            {
        ...
        {
            if (_navigating || _anchors == null || DataContext is not ChipDemoViewModel) return;
            UpdateActiveToc();
        }

        private void UpdateActiveToc()
        {
            if (_anchors == null || DataContext is not ChipDemoViewModel) return;
