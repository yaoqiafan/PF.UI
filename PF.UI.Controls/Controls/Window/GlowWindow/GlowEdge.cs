...
public class GlowEdge : HwndWrapper
{
    ...
    public static long CreatedGlowEdges { get; private set; }

    public static long DisposedGlowEdges { get; private set; }

    public GlowEdge(GlowWindow owner, Dock orientation)
    {
    ...
    public void ChangeOwner(IntPtr newOwner) => InteropMethods.SetWindowLongPtr(Handle, InteropValues.GWLP.HWNDPARENT, newOwner);
