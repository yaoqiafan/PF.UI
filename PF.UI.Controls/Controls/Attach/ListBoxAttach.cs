...
public class ListBoxAttach
{
    ...
    public static readonly DependencyProperty InternalActionProperty = DependencyProperty.RegisterAttached(
        "InternalAction", typeof(bool), typeof(ListBoxAttach), new PropertyMetadata(ValueBoxes.FalseBox));

    public static void SetInternalAction(DependencyObject element, bool value)
        => element.SetValue(InternalActionProperty, ValueBoxes.BooleanBox(value));

    public static bool GetInternalAction(DependencyObject element)
