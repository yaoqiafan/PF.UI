...
public class CoverViewContent : ContentControl
{
    ...
    public static readonly DependencyProperty ManualHeightProperty = DependencyProperty.Register(
    ...
    public void UpdatePosition(int index, int groups, double itemWidth)
    {
        if (_triangle == null)
        {
            _index = index;
