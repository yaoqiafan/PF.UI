...
public class ArcGeometrySource : GeometrySource<IArcGeometrySourceParameters>
{
    ...
    public static double[] ComputeAngleRanges(double radiusX, double radiusY, double intersect,
    ...
    public static double EnsureFirstQuadrant(double angle)
    {
    ...
    public static double InnerCurveSelfIntersect(double radiusX, double radiusY, double thickness)
    {
        var angleA = 0.0;
