...
/// <summary>
/// 完整的 Material Design 颜色枚举（19种颜色 × 14个色调层级 = 266个值）。
/// 每个颜色的 500 值有别名（如 Blue = Blue500）。
/// </summary>
...
/// <summary>
/// Material Design 主色枚举（19种），值映射为各颜色 500 层级。
/// </summary>
...
/// <summary>
/// Material Design 次色枚举（16种），值映射为各颜色 A700 层级。
/// </summary>
