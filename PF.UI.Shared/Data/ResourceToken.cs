...
public class ResourceToken
{
    ...
    public const string BlurGradientValue = nameof(BlurGradientValue);

    public const string ButtonCustom = nameof(ButtonCustom);

    public const string PaginationButtonStyle = nameof(PaginationButtonStyle);

    public const string WindowWin10 = nameof(WindowWin10);

    public const string WindowBlur = nameof(WindowBlur);

    public const string WindowGlow = nameof(WindowGlow);

    public const string Window4ScreenshotStyle = nameof(Window4ScreenshotStyle);

    public const string AddTagButtonStyle = nameof(AddTagButtonStyle);

    public const string RadioGroupItemDefault = nameof(RadioGroupItemDefault);

    public const string RadioGroupItemSingle = nameof(RadioGroupItemSingle);

    public const string RadioGroupItemHorizontalFirst = nameof(RadioGroupItemHorizontalFirst);

    public const string RadioGroupItemHorizontalLast = nameof(RadioGroupItemHorizontalLast);

    public const string RadioGroupItemVerticalFirst = nameof(RadioGroupItemVerticalFirst);

    public const string RadioGroupItemVerticalLast = nameof(RadioGroupItemVerticalLast);

    public const string ButtonGroupItemDefault = nameof(ButtonGroupItemDefault);

    public const string ButtonGroupItemSingle = nameof(ButtonGroupItemSingle);

    public const string ButtonGroupItemHorizontalFirst = nameof(ButtonGroupItemHorizontalFirst);

    public const string ButtonGroupItemHorizontalLast = nameof(ButtonGroupItemHorizontalLast);

    public const string ButtonGroupItemVerticalFirst = nameof(ButtonGroupItemVerticalFirst);

    public const string ButtonGroupItemVerticalLast = nameof(ButtonGroupItemVerticalLast);

    public const string ToggleButtonGroupItemDefault = nameof(ToggleButtonGroupItemDefault);

    public const string ToggleButtonGroupItemSingle = nameof(ToggleButtonGroupItemSingle);

    public const string ToggleButtonGroupItemHorizontalFirst = nameof(ToggleButtonGroupItemHorizontalFirst);

    public const string ToggleButtonGroupItemHorizontalLast = nameof(ToggleButtonGroupItemHorizontalLast);

    public const string ToggleButtonGroupItemVerticalFirst = nameof(ToggleButtonGroupItemVerticalFirst);

    public const string ToggleButtonGroupItemVerticalLast = nameof(ToggleButtonGroupItemVerticalLast);

    public const string TabItemCapsuleDefault = nameof(TabItemCapsuleDefault);

    public const string TabItemCapsuleSingle = nameof(TabItemCapsuleSingle);

    public const string TabItemCapsuleHorizontalFirst = nameof(TabItemCapsuleHorizontalFirst);

    public const string TabItemCapsuleHorizontalLast = nameof(TabItemCapsuleHorizontalLast);

    public const string TabItemCapsuleVerticalFirst = nameof(TabItemCapsuleVerticalFirst);

    public const string TabItemCapsuleVerticalLast = nameof(TabItemCapsuleVerticalLast);

    public const string ComboBoxItemCapsuleDefault = nameof(ComboBoxItemCapsuleDefault);

    public const string ComboBoxItemCapsuleSingle = nameof(ComboBoxItemCapsuleSingle);

    public const string ComboBoxItemCapsuleHorizontalFirst = nameof(ComboBoxItemCapsuleHorizontalFirst);

    public const string ComboBoxItemCapsuleHorizontalLast = nameof(ComboBoxItemCapsuleHorizontalLast);

    public const string ComboBoxItemCapsuleVerticalFirst = nameof(ComboBoxItemCapsuleVerticalFirst);
